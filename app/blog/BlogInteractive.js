...
export function ShareBar({ url }) {
  const handleShare = (platform = "native") => {
    const text = "Check out these timing and productivity tips!";
    if (platform === "twitter") {
      window.open(
  ...
  return (
    <section className="mt-16 bg-white/10 backdrop-blur-lg rounded-xl p-8 border border-white/20 text-center">
      ...
      <p className="text-white/80 mb-6 max-w-2xl mx-auto">
        Get the latest productivity tips, sports timing insights, and stopwatch
        techniques delivered to your inbox monthly.
      </p>
