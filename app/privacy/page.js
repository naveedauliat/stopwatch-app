      ...
      <div className="max-w-4xl mx-auto">
        <div className="bg-gray-900/80 backdrop-blur-xl rounded-3xl p-8 md:p-12 border border-gray-700/50 shadow-2xl">
          <div className="text-center mb-12">
            ...
            <div className="inline-flex items-center gap-2 bg-green-900/40 text-green-300 px-4 py-2 rounded-full border border-green-700/50 mt-4">
          ...
          <div className="prose prose-invert max-w-none space-y-8">
            {/* Privacy Overview */}
            <section className="bg-blue-900/30 rounded-xl p-6 border border-blue-700/40">
              <h2 className="text-xl font-bold text-blue-300 mb-3">🔒 Your Privacy Matters</h2>
              ...
              <div className="text-gray-300 space-y-4">
                ...
                <div className="bg-gray-800/60 rounded-xl p-4 border border-gray-600/40">
                  <ul className="list-disc list-inside space-y-2">
                    <li><strong className="text-gray-200">Usage Analytics:</strong> Basic website usage statistics (page views, session duration)</li>
                    <li><strong className="text-gray-200">Technical Data:</strong> Browser type, device type, screen resolution for optimization</li>
                    <li><strong className="text-gray-200">Performance Data:</strong> Load times and error reports to improve service quality</li>
                  </ul>
                </div>
                ...
                <div className="bg-gray-800/60 rounded-xl p-4 border border-gray-600/40">
                  <ul className="list-disc list-inside space-y-2">
                    <li><strong className="text-gray-200">Newsletter Subscription:</strong> Email address (only if you subscribe)</li>
                    <li><strong className="text-gray-200">Contact Forms:</strong> Name and email when you contact us</li>
                    <li><strong className="text-gray-200">Feedback:</strong> Any feedback or suggestions you provide</li>
                  </ul>
                </div>

                <h3 className="text-lg font-semibold text-gray-200">Local Storage</h3>
                <div className="bg-gray-800/60 rounded-xl p-4 border border-gray-600/40">
                  <ul className="list-disc list-inside space-y-2">
                    <li><strong className="text-gray-200">Timing Data:</strong> Stored locally on your device for offline functionality</li>
                    <li><strong className="text-gray-200">User Preferences:</strong> Settings and customizations saved locally</li>
                    <li><strong className="text-gray-200">Session Data:</strong> Temporary data for current timing sessions</li>
                  </ul>
            ...
            <section>
              ...
              <div className="text-gray-300 space-y-4">
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  <div className="bg-green-900/30 rounded-xl p-4 border border-green-700/40">
                    <h4 className="font-semibold text-green-300 mb-2">✅ Service Improvement</h4>
                  ...
                  <div className="bg-blue-900/30 rounded-xl p-4 border border-blue-700/40">
                    <h4 className="font-semibold text-blue-300 mb-2">📊 Analytics</h4>
                    <ul className="text-sm space-y-1 text-gray-300">
                  ...
                  <div className="bg-purple-900/30 rounded-xl p-4 border border-purple-700/40">
                  ...
                  <div className="bg-orange-900/30 rounded-xl p-4 border border-orange-700/40">
                    <h4 className="font-semibold text-orange-300 mb-2">🔒 Security</h4>
                    <ul className="text-sm space-y-1 text-gray-300">
            ...
            <section>
              ...
              <div className="text-gray-300 space-y-4">
                <div className="bg-red-900/30 rounded-xl p-4 border border-red-700/40">
                  <h4 className="font-semibold text-red-300 mb-2">🚫 We DO NOT Sell Your Data</h4>
                ...
                <ul className="list-disc list-inside space-y-2 ml-4">
                  <li><strong className="text-gray-200">Service Providers:</strong> Trusted third-party services that help operate our website (analytics, hosting)</li>
                  <li><strong className="text-gray-200">Legal Requirements:</strong> When required by law or to protect our rights and safety</li>
                  <li><strong className="text-gray-200">Business Transfer:</strong> In case of merger, acquisition, or asset sale (users will be notified)</li>
                  <li><strong className="text-gray-200">Consent:</strong> When you explicitly consent to sharing</li>
                </ul>

                <div className="bg-gray-800/60 rounded-xl p-4 border border-gray-600/40">
                  <h4 className="font-semibold text-gray-200 mb-2">Third-Party Services We Use:</h4>
                  <ul className="text-sm space-y-1 text-gray-300">
                    <li>• <strong className="text-gray-200">Analytics:</strong> Google Analytics (anonymized data)</li>
                    <li>• <strong className="text-gray-200">Hosting:</strong> Vercel (for website hosting)</li>
                    <li>• <strong className="text-gray-200">Email:</strong> Newsletter service provider (if you subscribe)</li>
                  </ul>
                </div>
              </div>
            </section>
            ...
            <section>
              ...
              <div className="text-gray-300 space-y-4">
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  <div className="bg-gray-800/60 rounded-xl p-4 border border-gray-600/40">
                    <h4 className="font-semibold text-gray-200 mb-2">🔐 Technical Safeguards</h4>
                    <ul className="text-sm space-y-1 text-gray-300">
                  ...
                  <div className="bg-gray-800/60 rounded-xl p-4 border border-gray-600/40">
                    <h4 className="font-semibold text-gray-200 mb-2">📋 Administrative Safeguards</h4>
                    <ul className="text-sm space-y-1 text-gray-300">
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  <div className="space-y-3">
                    <div className="bg-blue-900/30 rounded-lg p-3 border border-blue-700/40">
                      <h4 className="font-semibold text-blue-300">📋 Access</h4>
                      <p className="text-sm text-gray-300">Request copies of your personal data</p>
                    </div>
                    <div className="bg-green-900/30 rounded-lg p-3 border border-green-700/40">
                      <h4 className="font-semibold text-green-300">✏️ Rectification</h4>
                      <p className="text-sm text-gray-300">Request correction of inaccurate data</p>
                    </div>
                    <div className="bg-red-900/30 rounded-lg p-3 border border-red-700/40">
                      <h4 className="font-semibold text-red-300">🗑️ Erasure</h4>
                  ...
                  <div className="space-y-3">
                    <div className="bg-orange-900/30 rounded-lg p-3 border border-orange-700/40">
                      <h4 className="font-semibold text-orange-300">⏸️ Restriction</h4>
                      <p className="text-sm text-gray-300">Request limitation of data processing</p>
                    </div>
                    <div className="bg-purple-900/30 rounded-lg p-3 border border-purple-700/40">
                      <h4 className="font-semibold text-purple-300">📤 Portability</h4>
                      <p className="text-sm text-gray-300">Request transfer of your data</p>
                    </div>
                    <div className="bg-gray-800/60 rounded-lg p-3 border border-gray-600/40">
                      <h4 className="font-semibold text-gray-300">❌ Objection</h4>
                      <p className="text-sm text-gray-300">Object to data processing</p>
                    </div>
                  </div>
                </div>
                <p>To exercise these rights, contact us at <strong className="text-blue-300">privacy@stopwatch.lol</strong></p>
              </div>
            </section>
            ...
            <section>
              ...
              <div className="text-gray-300 space-y-4">
                ...
                <div className="bg-gray-800/60 rounded-xl p-4 border border-gray-600/40">
                  <h4 className="font-semibold text-gray-200 mb-2">🍪 Cookie Types:</h4>
                  <ul className="space-y-2 text-gray-300">
                    <li><strong className="text-gray-200">Essential Cookies:</strong> Required for basic website functionality</li>
                    <li><strong className="text-gray-200">Analytics Cookies:</strong> Help us understand website usage (anonymized)</li>
            ...
            <section>
              ...
              <div className="text-gray-300 space-y-4">
                ...
                <p>
                  ...
                  personal information, please contact us at <span className="text-blue-300">privacy@stopwatch.lol</span>.
                </p>
              </div>
            </section>
            ...
            <section>
              ...
              <div className="text-gray-300 space-y-4">
                ...
                <div className="bg-gray-800/60 rounded-xl p-6 border border-gray-600/40">
                  <div className="grid md:grid-cols-2 gap-4">
                    <div>
                      <h4 className="font-semibold text-gray-200 mb-2">📧 Email</h4>
                      <p className="text-blue-300">privacy@stopwatch.lol</p>
                      <p className="text-gray-400 text-sm">For privacy-related inquiries</p>
                    </div>
                    <div>
                      <h4 className="font-semibold text-gray-200 mb-2">🌐 Website</h4>
                      <p className="text-blue-300">https://stopwatch.lol</p>
                      <p className="text-gray-400 text-sm">Visit our main website</p>
                    </div>
                  </div>
                  <div className="mt-4 pt-4 border-t border-gray-600/40">
                    <p className="text-gray-400 text-sm">
                      <strong className="text-gray-300">Response Time:</strong> We typically respond to privacy inquiries within 48 hours.
                    </p>
                  </div>
                </div>
              </div>
